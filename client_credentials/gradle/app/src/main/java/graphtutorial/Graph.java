...
public class Graph {
    ...
    public static void initializeGraphAuth(String CLIENT_ID, String CLIENT_SECRET, String TENANT_GUID,
        ...
        final InetSocketAddress proxyInetAddress = new InetSocketAddress("PROXY_IP_HERE", proxyPort);
        ...
        final ClientSecretCredential clientSecretCredential = new ClientSecretCredentialBuilder()
                ...
                // .httpClient(azHttpClient) // Uncomment this to enable proxy
                .build();
        ...
        graphClient = GraphServiceClient.builder()
                .authenticationProvider(authProvider) // If no proxy use this else use the `httpClient(graphHttpClient)`
                // .httpClient(graphHttpClient) // Use it if proxy is enabled
                .logger(logger)
                .buildClient();
    }
    ...
    public static UserCollectionPage getUsers() {
        if (graphClient == null)
